						...
						<div class="col-md-12">
							<div class="alert alert-dismissable alert-info">
								...
								<div>
									...
									<button type="submit"  name="btn-reserva" class="btn btn-danger btn-default">
										Registrar Retiro
									</button> 
						...
						<div class="col-md-12">
							<div class="alert alert-dismissable alert-info">
								...
								<div>
									...
									<button type="submit" name="btn-devolucion" class="btn btn-danger btn-default">
										Registrar
									</button> 
									<button type="button" class="btn btn-default " data-dismiss="alert" aria-hidden="true">
										Cancelar
						...
						<div class="col-md-12">
							<div class="alert alert-dismissable alert-info">
								...
								<div>
									...
									<button type="submit" name="btn-cancelar" class="btn btn-danger btn-default">
										Registrar
									</button> 
									<button type="button" class="btn btn-default " data-dismiss="alert" aria-hidden="true">
										Cancelar
